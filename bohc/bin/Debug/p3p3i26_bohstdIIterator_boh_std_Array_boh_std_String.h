...
struct p3p3i26_bohstdIIterator_boh_std_Array_boh_std_String
{
	...
	struct p3p3c14_bohstdArray_boh_std_String * (*m_current_35cf4c)(struct p3p3c6_bohstdObject * const self);
};

...
extern struct p3p3i10_bohstdICollection_char * new_p3p3i10_bohstdICollection_char(struct p3p3c6_bohstdObject * object, struct p3p3iE_bohstdIIterator_char * (*m_iterator_35cf4c)(struct p3p3c6_bohstdObject * const self), struct p3p3cA_bohstdQuery_char * (*m_query_35cf4c)(struct p3p3c6_bohstdObject * const self));

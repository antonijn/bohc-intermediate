...
extern struct p3p3c14_bohstdArray_boh_std_String * new_p3p3c14_bohstdArray_boh_std_String_adeaa357(int32_t p_length);
...
#endif
extern void p3p3c14_bohstdArray_boh_std_String_m_this_adeaa357(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_length);
extern int32_t p3p3c14_bohstdArray_boh_std_String_m_size_35cf4c(struct p3p3c14_bohstdArray_boh_std_String * const self);
extern struct p3p3c6_bohstdString * p3p3c14_bohstdArray_boh_std_String_m_get_adeaa357(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_i);
extern void p3p3c14_bohstdArray_boh_std_String_m_set_d881ed08(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_i, struct p3p3c6_bohstdString * p_value);
extern struct p3p3c6_bohstdString * p3p3c14_bohstdArray_boh_std_String_m_getFast_adeaa357(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_i);
extern void p3p3c14_bohstdArray_boh_std_String_m_setFast_d881ed08(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_i, struct p3p3c6_bohstdString * p_value);
extern struct p3p3i18_bohstdIIterator_boh_std_String * p3p3c14_bohstdArray_boh_std_String_m_iterator_35cf4c(struct p3p3c14_bohstdArray_boh_std_String * const self);
extern struct p3p3c14_bohstdQuery_boh_std_String * p3p3c14_bohstdArray_boh_std_String_m_query_35cf4c(struct p3p3c14_bohstdArray_boh_std_String * const self);
extern void p3p3c14_bohstdArray_boh_std_String_m_resize_adeaa357(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_newsize);
extern void p3p3c14_bohstdArray_boh_std_String_m_move_10aba1b7(struct p3p3c14_bohstdArray_boh_std_String * const self, int32_t p_dest, int32_t p_src, int32_t p_size);
extern void p3p3c14_bohstdArray_boh_std_String_m_static_0(void);

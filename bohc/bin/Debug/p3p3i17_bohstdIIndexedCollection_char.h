...
extern struct p3p3i17_bohstdIIndexedCollection_char * new_p3p3i17_bohstdIIndexedCollection_char(struct p3p3c6_bohstdObject * object, struct p3p3iE_bohstdIIterator_char * (*m_iterator_35cf4c)(struct p3p3c6_bohstdObject * const self), int32_t (*m_size_35cf4c)(struct p3p3c6_bohstdObject * const self), unsigned char (*m_get_adeaa357)(struct p3p3c6_bohstdObject * const self, int32_t p_i));

struct p3p3i17_bohstdIIndexedCollection_char
{
	struct p3p3c6_bohstdObject * object;
	struct p3p3iE_bohstdIIterator_char * (*m_iterator_35cf4c)(struct p3p3c6_bohstdObject * const self);
	int32_t (*m_size_35cf4c)(struct p3p3c6_bohstdObject * const self);
	unsigned char (*m_get_adeaa357)(struct p3p3c6_bohstdObject * const self, int32_t p_i);
};

...
extern struct p2p4c9_mypackMainClass * new_p2p4c9_mypackMainClass_35cf4c(void);

extern void p2p4c9_mypackMainClass_fi(struct p2p4c9_mypackMainClass * const self);

#if defined(PF_LINUX)
extern void p2p4c9_mypackMainClass_m_vfun_35cf4c(struct p2p4c9_mypackMainClass * const self);
#endif
extern void p2p4c9_mypackMainClass_m_this_35cf4c(struct p2p4c9_mypackMainClass * const self);
extern void p2p4c9_mypackMainClass_m_static_0(void);
...
#if defined(PF_LINUX)
	void (*m_vfun_35cf4c)(struct p2p4c9_mypackMainClass * const self);
#endif
};

...
struct c_boh_p_lang_p_Vector3_boh_lang_String
{
	struct c_boh_p_lang_p_String * f_x;
	struct c_boh_p_lang_p_String * f_y;
	struct c_boh_p_lang_p_String * f_z;
};
...
extern struct c_boh_p_lang_p_Type * typeof_c_boh_p_lang_p_Vector3_boh_lang_String(void);

extern struct c_boh_p_lang_p_Vector3_boh_lang_String new_c_boh_p_lang_p_Vector3_boh_lang_String(struct c_boh_p_lang_p_String * p_x, struct c_boh_p_lang_p_String * p_y, struct c_boh_p_lang_p_String * p_z);

extern void c_boh_p_lang_p_Vector3_boh_lang_String_m_this_54760982(struct c_boh_p_lang_p_Vector3_boh_lang_String * const self, struct c_boh_p_lang_p_String * p_x, struct c_boh_p_lang_p_String * p_y, struct c_boh_p_lang_p_String * p_z);
extern struct c_boh_p_lang_p_Vector3_boh_lang_String c_boh_p_lang_p_Vector3_boh_lang_String_op_add_239811068(struct c_boh_p_lang_p_Vector3_boh_lang_String p_left, struct c_boh_p_lang_p_Vector3_boh_lang_String p_right);

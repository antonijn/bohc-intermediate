...
extern struct p3p3iF_bohstdICollection_int * new_p3p3iF_bohstdICollection_int(struct p3p3c6_bohstdObject * object, struct p3p3iD_bohstdIIterator_int * (*m_iterator_35cf4c)(struct p3p3c6_bohstdObject * const self));

...
struct p3p3iE_bohstdIIterator_long;
...
extern struct p3p3iE_bohstdIIterator_long * new_p3p3iE_bohstdIIterator_long(struct p3p3c6_bohstdObject * object, _Bool (*m_next_35cf4c)(struct p3p3c6_bohstdObject * const self), _Bool (*m_previous_35cf4c)(struct p3p3c6_bohstdObject * const self), void (*m_moveLast_35cf4c)(struct p3p3c6_bohstdObject * const self), void (*m_reset_35cf4c)(struct p3p3c6_bohstdObject * const self), int64_t (*m_current_35cf4c)(struct p3p3c6_bohstdObject * const self));
...
struct p3p3iE_bohstdIIterator_long
{
	...
	int64_t (*m_current_35cf4c)(struct p3p3c6_bohstdObject * const self);
};

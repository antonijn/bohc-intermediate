...
extern struct p3p3iD_bohstdIIterator_int * new_p3p3iD_bohstdIIterator_int(struct p3p3c6_bohstdObject * object, _Bool (*m_next_35cf4c)(struct p3p3c6_bohstdObject * const self), _Bool (*m_previous_35cf4c)(struct p3p3c6_bohstdObject * const self), void (*m_moveLast_35cf4c)(struct p3p3c6_bohstdObject * const self), void (*m_reset_35cf4c)(struct p3p3c6_bohstdObject * const self), int32_t (*m_current_35cf4c)(struct p3p3c6_bohstdObject * const self));
...
struct p3p3iD_bohstdIIterator_int
{
	...
	int32_t (*m_current_35cf4c)(struct p3p3c6_bohstdObject * const self);
};

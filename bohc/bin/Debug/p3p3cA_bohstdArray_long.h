...
struct p3p3cA_bohstdArray_long;
...
extern struct p3p3c4_bohstdType * typeof_p3p3cA_bohstdArray_long(void);

extern struct p3p3cA_bohstdArray_long * new_p3p3cA_bohstdArray_long_adeaa357(int32_t p_length);

extern void p3p3cA_bohstdArray_long_fi(struct p3p3cA_bohstdArray_long * const self);

extern void p3p3cA_bohstdArray_long_m_this_adeaa357(struct p3p3cA_bohstdArray_long * const self, int32_t p_length);
extern int32_t p3p3cA_bohstdArray_long_m_size_35cf4c(struct p3p3cA_bohstdArray_long * const self);
extern int64_t p3p3cA_bohstdArray_long_m_get_adeaa357(struct p3p3cA_bohstdArray_long * const self, int32_t p_i);
extern void p3p3cA_bohstdArray_long_m_set_d5b199be(struct p3p3cA_bohstdArray_long * const self, int32_t p_i, int64_t p_value);
extern int64_t p3p3cA_bohstdArray_long_m_getFast_adeaa357(struct p3p3cA_bohstdArray_long * const self, int32_t p_i);
extern void p3p3cA_bohstdArray_long_m_setFast_d5b199be(struct p3p3cA_bohstdArray_long * const self, int32_t p_i, int64_t p_value);
extern struct p3p3iE_bohstdIIterator_long * p3p3cA_bohstdArray_long_m_iterator_35cf4c(struct p3p3cA_bohstdArray_long * const self);
extern void p3p3cA_bohstdArray_long_m_resize_adeaa357(struct p3p3cA_bohstdArray_long * const self, int32_t p_newsize);
extern void p3p3cA_bohstdArray_long_m_move_10aba1b7(struct p3p3cA_bohstdArray_long * const self, int32_t p_dest, int32_t p_src, int32_t p_size);
extern void p3p3cA_bohstdArray_long_m_static_0(void);


struct vtable_p3p3cA_bohstdArray_long
{
...
extern const struct vtable_p3p3cA_bohstdArray_long instance_vtable_p3p3cA_bohstdArray_long;

struct p3p3cA_bohstdArray_long
{
	const struct vtable_p3p3cA_bohstdArray_long * vtable;
	int32_t f_length;
	int64_t* f_items;
};

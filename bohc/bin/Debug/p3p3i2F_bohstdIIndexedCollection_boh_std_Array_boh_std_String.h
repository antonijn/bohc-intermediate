...
struct p3p3i2F_bohstdIIndexedCollection_boh_std_Array_boh_std_String
{
	...
	struct p3p3c14_bohstdArray_boh_std_String * (*m_get_adeaa357)(struct p3p3c6_bohstdObject * const self, int32_t p_i);
};

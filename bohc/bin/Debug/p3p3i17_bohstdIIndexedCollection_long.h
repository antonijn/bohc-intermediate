...
struct p3p3i17_bohstdIIndexedCollection_long;
...
struct p3p3i17_bohstdIIndexedCollection_long
{
	...
	int64_t (*m_get_adeaa357)(struct p3p3c6_bohstdObject * const self, int32_t p_i);
};

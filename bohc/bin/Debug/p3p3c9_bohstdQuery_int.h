...
extern struct p3p3c4_bohstdType * typeof_p3p3c9_bohstdQuery_int(void);

extern struct p3p3c9_bohstdQuery_int * new_p3p3c9_bohstdQuery_int_e625b83f(struct p3p3iF_bohstdICollection_int * p_base);

extern void p3p3c9_bohstdQuery_int_fi(struct p3p3c9_bohstdQuery_int * const self);

extern void p3p3c9_bohstdQuery_int_m_this_e625b83f(struct p3p3c9_bohstdQuery_int * const self, struct p3p3iF_bohstdICollection_int * p_base);
extern struct p3p3iD_bohstdIIterator_int * p3p3c9_bohstdQuery_int_m_iterator_35cf4c(struct p3p3c9_bohstdQuery_int * const self);
extern struct p3p3c9_bohstdQuery_int * p3p3c9_bohstdQuery_int_m_where_5a618770(struct p3p3c9_bohstdQuery_int * const self, struct f1E_p07_booleanp3p3c6_bohstdString p_condition);
extern struct p3p3c9_bohstdQuery_int * p3p3c9_bohstdQuery_int_m_query_35cf4c(struct p3p3c9_bohstdQuery_int * const self);
extern void p3p3c9_bohstdQuery_int_m_static_0(void);


struct vtable_p3p3c9_bohstdQuery_int
{
...
extern const struct vtable_p3p3c9_bohstdQuery_int instance_vtable_p3p3c9_bohstdQuery_int;

struct p3p3c9_bohstdQuery_int
{
	const struct vtable_p3p3c9_bohstdQuery_int * vtable;
	struct p3p3iF_bohstdICollection_int * f_base;
};
